                    ...
                    {navItems.map((item, i) => (
                      ...
                      >
                        ...
                        >
                          ...
                          <ArrowRight className="relative w-4 h-4 opacity-0 -translate-x-2 transition-all duration-300 group-hover:opacity-60 group-hover:translate-x-0 group-hover:text-primary" />
                        </Link>
                      </motion.li>
                    ))}
                  </ul>
