...
export async function checkRateLimit(
    ...
    try {
        ...
        // INCR is atomic, unlike a separate GET/SET pair. Refreshing the expiry
        // on every increment provides a rolling window and prevents a partial
        // network failure from leaving a counter without a TTL.
        ...
        // Keep protection active on transient KV failures. This fallback is
        // per-instance, but is safer than allowing unlimited requests.
        return checkMemoryRateLimit(identifier, type);
    }
}
